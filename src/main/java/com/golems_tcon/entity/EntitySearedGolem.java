...
public class EntitySearedGolem extends GolemBase
{
	...
	{
		super(world, TGConfig.SEARED.getBaseAttack());
	...
	{
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(TGConfig.SEARED.getMaxHealth());
	...
	{
		return this.makeGolemTexture(TconGolems.MODID, "seared");
	}
